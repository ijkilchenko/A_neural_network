...
def main():
    ...
    if (os.path.exists(dir + '../my_books')):
        ...
        file_names = [name for name in os.listdir(dir)][0:2]
    ...
    # Do training and testing on 20% of all 5-sentence chunks
    # Sentences are further broken down into a train and test sets by Ann
    ...
    for book in books:
        ...
        # Randomly pick 20% of all 5-sentence chunks
        samples = random.sample(range(0, num_chunks), num_samples)
    ...
    ann.train()
    print('Printing our hypothesis for the test set')
    # print(ann.validate_train())
